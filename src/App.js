        ...
        ReactDOM.createPortal(
          <div className="modal-overlay" onClick={() => setAlert(null)}>
            ...
            >
              ...
              <p>
                {alert.mode === "add"
                  ? <><strong>{alert.name}</strong> has been successfully enrolled.</>
                  : <><strong>{alert.name}</strong>'s details have been updated successfully.</>}
              </p>
              <div className="success-progress">
                <div className="success-progress-bar" />
              </div>
              <div className="modal-actions">
                <button className="btn-success-ok" onClick={() => setAlert(null)}>
                  Got it!
                </button>
              </div>
            </div>
